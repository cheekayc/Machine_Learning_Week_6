...
# Create 10-fold cross-validation and use down-sampling because of imbalance in outcome
...
```
The best tuned parameter (C) = 1.9184. It has 549 support vectors, with an average training error of 0.2359 and an average accuracy of 0.7126.
...
Between the SVM and Logistic Regression models, I decided to choose the **SVM model** although the Logistic Regression model has a higher accuracy than the SVM model. However, according to the confusion matrix, more percentage of 'Yes' diabetes were correctly predicted as 'Yes' diabetes in the SVM model (8.1% compared to 7.9%). 
